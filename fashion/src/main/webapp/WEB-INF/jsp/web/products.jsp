			...
			<div class="new-product">
				...
				<div class="mens-toolbar">
                 <div class="sort">
               	   <div class="sort-by">
			            ...
			            <a href=""><img src="<c:url value= 'resources/images/arrow2.gif'/>" alt="" class="v-middle"></a>
	                   </div>
	    		     </div>
        	 ...
        	 <div class="limiter visible-desktop">
               <label>Show</label>
				...
				<script src="<c:url value= 'resources/js/cbpViewModeSwitch.js'/>" type="text/javascript"></script>
   ...
   <!-- content-section-ends -->
		...
		<div class="container">
			<h3 class="like text-center">Featured Collection</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single.html"><img src="<c:url value= 'resources/images/l1.jpg'/>" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Perfectly simple</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value= 'resources/images/l2.jpg'/>" class="img-responsive"/></a>						
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Praising pain</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value= 'resources/images/l3.jpg'/>" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Neque porro</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$329</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value= 'resources/images/l4.jpg'/>" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Equal blame</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$499</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value= 'resources/images/l5.jpg'/>" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Perfectly simple</a>
