					...
					<div class="cart box_1">
						<a href="checkout.html">
							<h3>
								...
								</span>)<img src="<c:url value ="resources/images/bag.png" />" alt="">
							</h3>
						</a>
						<p>
		...
		<div class="container">
			...
			<div class="cart-gd">
				...
				<div class="cart-header">
					...
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<img src="<c:url value= 'resources/images/l1.jpg' /> "
				...
				<div class="cart-header2">
					...
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<img src="<c:url value= 'resources/images/l2.jpg' /> "
								class="img-responsive" alt="">
						</div>
						<div class="cart-item-info">
							<h3>
				...
				<div class="cart-header3">
					...
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<img
								src="<c:url value= 'resources/images/l3.jpg'/>" class="img-responsive" alt="">
						</div>
						<div class="cart-item-info">
							<h3>
								<a href="#"> Lorem Ipsum is not simply </a><span>Pickup
	...
	<div class="footer">
		<div class="container">
			...
			<div class="copyright text-center">
				<p>
					Â© 2015 Eshop. All Rights Reserved | Design by <a
