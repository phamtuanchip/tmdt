	...
	<div class="shop">
		...
		<div class="container">
			<div class="main-content">
				...
				<header>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.html"><img src="<c:url value ='/resources/images/web/p4.jpg'/>" alt="" /></a>
						<div class="mask">
							<a href="single.html">Quick View</a>
						</div>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.html"><img src="<c:url value ='/resources/images/web/p5.jpg'/>" alt="" /></a>
						<div class="mask">
							<a href="single.html">Quick View</a>
						</div>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.html"><img src="<c:url value ='/resources/images/web/p6.jpg'/>" alt="" /></a>
						<div class="mask">
							<a href="single.html">Quick View</a>
						</div>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.html"><img src="<c:url value ='/resources/images/web/p7.jpg'/>" alt="" /></a>
						<div class="mask">
							<a href="single.html">Quick View</a>
						</div>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.html"><img src="<c:url value ='/resources/images/web/p8.jpg'/>" alt="" /></a>
						<div class="mask">
							<a href="single.html">Quick View</a>
						</div>
						<a class="product_name" href="single.html">perfectly simple</a>
					...
					<div class="col-md-4 product simpleCart_shelfItem text-center">
						<a href="single.html"><img src="<c:url value ='/resources/images/web/p9.jpg'/>" alt="" /></a>
						<div class="mask">
							<a href="single.html">Quick View</a>
						</div>
		...
		<div class="container">
			<h3 class="like text-center">Featured Collection</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single.html"><img src="<c:url value ='/resources/images/web/l1.jpg'/>" class="img-responsive" alt="" /></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">perfectly simple</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value ='/resources/images/web/l2.jpg'/>" class="img-responsive" alt="" /></a>						
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">praising pain</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value ='/resources/images/web/l3.jpg'/>" class="img-responsive" alt="" /></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Neque porro</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$329</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value ='/resources/images/web/l4.jpg'/>" class="img-responsive" alt="" /></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">equal blame</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$499</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="<c:url value ='/resources/images/web/l5.jpg'/>" class="img-responsive" alt="" /></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">perfectly simple</a>
