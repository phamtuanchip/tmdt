<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionLogin_Delete.aspx.cs" Inherits="WebComputer.Admin.ActionLogin_Delete" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #C0C0C0">
                    <tr>
                        <th class="Title" align="left" colspan="2">
                            <%=Lang["DeleteActionLogin"].ToString()%>
                        </th>
                    </tr>                    
                    <tr>
                        ...
                        <td align="left" style="padding-top: 5px; padding-left: 5px; width:75%">
                            <cc_delete:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList CssClass="textbox" ID="DDL_ActionDelete" runat="server" OnSelectedIndexChanged="ActionLogin_SelectIndexChanged" AutoPostBack="true">                                        
                                    </asp:DropDownList>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <th class="Title" align="left" colspan="2">
                        <asp:Button CssClass="button" ID="Delete_ActionLogin" runat="server" OnClick="Delete_ActionLogin_Click" />                        
                    </th>
                </tr>
            </table>
        </div>
