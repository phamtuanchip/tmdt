<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ActionLog_Action.aspx.cs" Inherits="WebComputer.Admin.ActionLog_Action" Title="Untitled Page" %>
                                ...
                                <table width="100%" id="Table2" runat="server" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td colspan="2" class="Footer" align="left">
                                            <asp:Button CssClass="button" ID="ActionLogSearch" runat="server" OnClick="ActionLogSearch_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                ...
                <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
                    ...
                    <tr>
                        <td>
                            <cc1:UpdatePanel ID="UpdatePN" runat="server">
                                <ContentTemplate>
                                    <asp:GridView Width="100%" ID="GV_ActionLog" runat="server" OnPageIndexChanging="GV_ActionLog_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemStyle CssClass="leftMenuAdmin" Height="18px" HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    &nbsp;<%#DataBinder.Eval(Container.DataItem, "ActionEx")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderStyle Height="18px" Width="25%" CssClass="SubTitle" />
                                                <HeaderTemplate>
                                                    <asp:Label ID="Group" runat="server"><%=Lang["detail"].ToString()%></asp:Label>
                                                </HeaderTemplate>
                                                <ItemStyle CssClass="leftMenuAdmin" Height="18px" HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    &nbsp;<%#DataBinder.Eval(Container.DataItem, "DetailInformation")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                    ...
                    <tr>
                        <td class="Title" style="height: 20" align="left">
                            <input id="bntLog_Delete" class="button" type="button" value='<%=strLog_Delete %>'
                                onclick='JavaScript:openwindow1("ActionLog_Delete.aspx","420","140");' />
                        </td>
                    </tr>
                </table>
            </td>
