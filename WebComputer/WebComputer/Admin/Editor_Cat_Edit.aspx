<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Editor_Cat_Edit.aspx.cs" Inherits="WebComputer.Admin.Editor_Cat_Edit" Title="Untitled Page" ValidateRequest ="false" %>
                ...
                <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
                    ...
                    <tr>
                        <td class="Title" style="height: 22px" align="left" colspan="2">
                            <asp:Button ID="NewsCat_Edit" runat="server" CssClass="button" OnClick="NewsCat_Edit_Click" />
