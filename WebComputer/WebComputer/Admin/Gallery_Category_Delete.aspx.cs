...
{
    public partial class Gallery_Category_Delete : System.Web.UI.Page
    {
        ...
        private string strAllowFunctions = "gallerycat_delete";
        private string strFunctionName = "Xóa danh mục Gallery";
        private int id = 0;
        ...
        {
            //=============Delete file=====================================
            string SQL = "SELECT PhotoID FROM TB_Gallery WHERE Cat_Id =" + id;
            SqlDataReader drd;
            ...
            //===========Edn Delete file===================================
            //===========Delete Database===================================
            SqlCommand comm = new SqlCommand("Delete_Cat_Gallery", this.objConn.SqlConn());
