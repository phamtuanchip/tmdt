<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Banner_Edit.aspx.cs" Inherits="WebComputer.Admin.Banner_Edit" Title="Untitled Page" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
            <tr>
                <td class="Title" style="height:22px" align="left"><%=Lang["Edit_Banner"].ToString()%></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="Title" style="height:22px" align="left">                            
                    <asp:Button ID="Edit_Banners" runat="server" CssClass="button" OnClick="Edit_Banners_Click" />
