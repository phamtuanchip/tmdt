<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Product_Addnew.aspx.cs" Inherits="WebComputer.Admin.Product_Addnew" Title="Untitled Page" ValidateRequest="false" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="1" style="border: 1px solid #c0c0c0">
            ...
            <tr>
                <td valign="top">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td align="left" colspan="2" class="ListContent" style="width: 100%; height: 20px; font-weight: bold">
                                <%=Lang["Product_Intro"].ToString()%> <br />
                        ...
                        <tr>
                        <td align="left" class="ListContent" style="width: 30%; height: 20px; font-weight: bold">
                               <asp:textbox  id="Text_Quatity" Columns="35" runat="server" Visible="False" ></asp:textbox>                                  
                            </td>
                        </tr>
            ...
            <tr>
                <td colspan="2" class="Title" style="height:32px; width: 70%" align="left"><%=Lang["OtherInfo"].ToString()%></td>                                
            </tr>
            <tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="1" style="border: 1px solid #c0c0c0">
            ...
            <tr>
                <td class="Title" style="height: 22px" align="left" colspan="2">
                    <asp:Button ID="Product_AddNew" runat="server" CssClass="button" OnClientClick="return checkSubmitToAddNewsProduct(this.form);" OnClick="Product_AddNew_Click" />
