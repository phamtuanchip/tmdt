<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Editor_Cat_AddNew.aspx.cs" Inherits="WebComputer.Admin.Editor_Cat_AddNew" Title="Untitled Page" ValidateRequest ="false" %>
                ...
                <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
                        ...
                        <td valign="top">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="SpacerTd" style="width: 77%">
                                        <asp:RadioButton GroupName="Postion" Checked="true" ID="rdMain" runat="server" />Giữa
                                        <asp:RadioButton GroupName="Postion" ID="rdRight" runat="server" />Phải
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="ListContent" style="width: 23%; height: 20px">
                    ...
                    <tr>
                        <td class="Title" style="height: 22px" align="left" colspan="2">
                            <asp:Button ID="NewsCat_AddNew" runat="server" CssClass="button" OnClick="NewsCat_AddNew_Click" />
