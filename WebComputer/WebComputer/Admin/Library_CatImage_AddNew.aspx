<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Library_CatImage_AddNew.aspx.cs" Inherits="WebComputer.Admin.Library_CatImage_AddNew" Title="Untitled Page" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
            ...
            <tr>
                <td class="Title" style="height:22px" align="left" colspan="2">
                    <asp:Button ID="Library_CatImages_AddNew" runat="server" CssClass="button" OnClick="Library_CatImages_AddNew_Click" />
