<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Logo_AddNew.aspx.cs" Inherits="WebComputer.Admin.Logo_AddNew" Title="Untitled Page" %>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="ListContent">
                                        <cc1:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <asp:ListBox CssClass="textbox" ID="LB_CatLogo" runat="server" SelectionMode="Multiple"
                                                    Visible="false"></asp:ListBox>
                                                <asp:RequiredFieldValidator ID="RFV_LB_CatLogo" CssClass="ListContent" runat="server"
                                                    ControlToValidate="LB_CatLogo" ErrorMessage="Danh mục logo không thể trống!"></asp:RequiredFieldValidator>
                                            </ContentTemplate>
                                        </cc1:UpdatePanel>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList CssClass="textbox" ID="DDL_TypeLogo" runat="server">
                                            ...
                                            <asp:ListItem Text="Công ty thành viên" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RFV_DDL_TypeLogo" CssClass="ListContent" ControlToValidate="DDL_TypeLogo"
                                            runat="server" ErrorMessage="Loại quảng cáo logo không thể trống!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="ListContent" style="width: 23%; height: 20px">
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_DDL_TypeLink" ControlToValidate="DDL_TypeLink"
                                            CssClass="ListContent" runat="server" ErrorMessage="Kiểu liên kết logo không thể trống!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="ListContent" style="width: 23%; height: 20px">
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_DDL_Location" ControlToValidate="DDL_Location"
                                            CssClass="ListContent" runat="server" ErrorMessage="Vị trí đặt logo không thể trống!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <%--<tr>
                                    <td align="left" class="ListContent" style="width: 23%; height: 20px">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <font class="ListContent">
                                            <%=Lang["Example"].ToString()%>
                                        </font>
                                        <asp:RequiredFieldValidator ID="RFV_tbLogoURL" ControlToValidate="tbLogoURL" CssClass="ListContent"
                                            runat="server" ErrorMessage="Đường dẫn logo không thể trống!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="ListContent" style="width: 23%; height: 20px">
				...
				//-->
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_fuImageName" ControlToValidate="fuImageName"
                                            CssClass="ListContent" runat="server" ErrorMessage="File upload không thể trống!"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="ListContent" style="width: 23%; height: 20px">
                    ...
                    <tr>
                        <td class="Title" style="height: 22px" align="left">
                            <asp:Button ID="AddNewLogo" runat="server" CssClass="button" OnClick="AddNewLogo_Click" />
