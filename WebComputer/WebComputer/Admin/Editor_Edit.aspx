<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Editor_Edit.aspx.cs" Inherits="WebComputer.Admin.Editor_Edit" Title="Untitled Page" ValidateRequest ="false" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="1" style="border: 1px solid #c0c0c0">
            <tr>
                <td class="Title" style="height:22px; width: 75%" align="left"><%=Lang["NewsEdit"].ToString()%></td>
            ...
            <tr>
                ...
                <td valign="top">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <div id="divImg"><%=strNewsImage%></div>
                                <input type="hidden" name="LeadImage" value=<%=NewsImage%> />
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="padding-top: 5px; padding-left: 5px; padding-bottom: 5px;
                                width: 80%" colspan="2" align="left">
                                <img onclick="javascript:Relate()" style="cursor: hand" src="/Images/Admin/Relate.gif"
                                    alt="" />
                                <div id="divRelate" style="display: none">
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #C0C0C0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 45%" id="ReceiveRelateNews" runat="server" align="left">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">&nbsp;</td>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="1" style="border: 1px solid #c0c0c0">
            ...
            <tr>
                <td class="Title" style="height: 22px" align="left" colspan="2">
                    <asp:Button ID="News_Edit" runat="server" CssClass="button" OnClientClick="return checkSubmitToAddNews(this.form);" OnClick="News_Edit_Click" />
                    <input type="reset" id="Reset_Form" runat="server" class="button" />
