<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="FAQs_AddNew.aspx.cs" Inherits="WebComputer.Admin.FAQs_AddNew" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center">
                <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
                    ...
                    <tr>
                        <td class="Title" style="height: 22px" align="left" colspan="2">
                            <asp:Button ID="FAQ_AddNew" runat="server" CssClass="button" OnClick="FAQ_AddNew_Click" />
