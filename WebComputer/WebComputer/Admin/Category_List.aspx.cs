...
namespace WebComputer.Admin
{
    public partial class Category_List : System.Web.UI.Page
    {
        ...
        private string strAllowFunctions = "Category_list";

        //private string strAllowFunction_Delete = "member_delete";
        private string strAllowFunction_Delete = "Category_delete";
        ...
        #region afdasf
        private void Get_All_Category()
        {
            this.GV_MemberList.DataSource = objBusinessLogic.CreateDataTable("pr_Select_Category", false);
        ...
        /*protected void GetMemberList()
        {
            ...
            SqlCommand comm = new SqlCommand("pr_Select_Category", objConn.SqlConn());
