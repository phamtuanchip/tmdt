...
{
    public partial class Gallery_View : System.Web.UI.Page
    {
        ...
        protected string LibraryImageView()
        {
            ...
            SqlDataReader drd;
            SqlCommand comdrd = new SqlCommand("Get_Gallery_Image", objConn.SqlConn());
        ...
        {
            Response.Redirect("Gallery_Edit.aspx?id=" + id);
        }
    }
}
