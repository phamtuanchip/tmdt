<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="LogoCat_AddNew.aspx.cs" Inherits="WebComputer.Admin.LogoCat_AddNew" Title="Untitled Page" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
            <tr>
                <td class="Title" style="height:22px" align="left" colspan="2"><%=Lang["LogoCatAddNew"].ToString()%></td>
            </tr>
            <tr>
                ...
                <td align="left" class="SpacerTd" style="width:77%">
                    <asp:DropDownList ID="DDL_Language" runat="server" OnSelectedIndexChanged="DDL_Language_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td align="left" class="SpacerTd">
                    <asp:RadioButton ID="RB_LBRandom1" GroupName="RB_LBRandom" CssClass="textbox" runat="server" Checked="true" /><font class="ListContent"><%=Lang["DisplayRandom"].ToString()%></font>&nbsp;
            ...
            <tr>
                <td class="Title" style="height:22px" align="left" colspan="2">
                    <asp:Button ID="AddNewCatLogo" runat="server" CssClass="button" OnClick="AddNewCatLogo_Click" />
