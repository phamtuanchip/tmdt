<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Member_YourAccount.aspx.cs" Inherits="WebComputer.Admin.Member_YourAccount" Title="Untitled Page" %>
                ...
                <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #c0c0c0">
                    ...
                    <tr>
                        <th colspan="2" class="Title" align="left">
                            <asp:Button ID="Member_Edit" CssClass="button" runat="server" OnClick="Member_Edit_Click" />
