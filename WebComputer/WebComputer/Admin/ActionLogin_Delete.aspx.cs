...
{
    public partial class ActionLogin_Delete : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Delete_ActionLogin.Text = Lang["delete"].ToString();
        ...
        protected void ActionLogin_SelectIndexChanged(object sender, EventArgs e)
        {
            if (this.DDL_ActionDelete.SelectedItem.Value.ToString() == "3")
            {
                idFromDate.Visible = true;
        ...
        protected void Delete_ActionLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (objBusinessLogic.Permission(this.strAllowFunctions) == true)
                {
                    DeleteActionLogin(intDDL_ActionDelete, strFromDate, strToDate);
                }
                else
                {
                    Response.Redirect("EOFPermission.aspx");
        ...
        protected void DeleteActionLogin(int intDDL_ActionDelete, string strFromDate, string strToDate)
        {
            SqlCommand comm = new SqlCommand("Delete_ActionLogin", objConn.SqlConn());
