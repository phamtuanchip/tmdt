<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Gallery_list.aspx.cs" Inherits="WebComputer.Admin.Gallery_list" Title="Untitled Page" %>
                        ...
                        <table width="20%" border="0" cellpadding="3" cellspacing="2">
                            <tr>
                                <td style="background-color: #EFF0F3" colspan="2" align="center">
                                    <a href="Gallery_View.aspx?id=<%#Eval("ID")%>">
