...
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/FPT/' ;
...
FCKConfig.ToolbarSets["Brief"] = [
	['Source','Bold','Italic','Underline','Image','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Link','Unlink'],
	['FontFormat','FontName','FontSize','SpecialChar','TextColor','BGColor']
] ;
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','About','Image']
] ;
