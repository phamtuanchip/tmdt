...
{
	//document.writeln('<table width="100%" border=1 cellspacing=0 cellpadding=1 bgcolor="#FFFFFF"><tr><td>');

	if (Header!='')
	{
		document.writeln('<table width="100%" border=0 cellspacing=0 cellpadding=0 style="border:1px solid #c0c0c0">');
		document.writeln('<tr>');
	...
	//document.writeln('<table width="100%" border=0 cellspacing=0 cellpadding=0 style="border:1px solid #c0c0c0; border-top:0px solid #c0c0c0""><tr><td id="IDM_', Name, '">');
