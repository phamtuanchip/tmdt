...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "/images/Admin/calendar/"			// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	var	monthName2 = new Array('Giêng','Hai','Ba','Tư','Năm','Sáu','Bảy','Tám','Chín','Mười','Mười Một','Chạp')
	if (startAt==0)
	{
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			document.getElementById("selectMonth").innerHTML = "<table width=100 style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0;' bgcolor='#FFFFDD' cellspacing=0 onmouseover='clearTimeout(timeoutID1)'	onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" +	sHTML +	"</table>"
   ...
   function WeekNbr(n) {
	...
	function constructCalendar () {
		...
		sHTML =	"<table	 border=0 style='font-family:Arial;font-size:9pt;'><tr>"
