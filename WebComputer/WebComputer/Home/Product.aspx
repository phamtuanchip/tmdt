<%@ Page Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="WebComputer.Home.Product" Title="Welcome to Chien Yen Computer" %>
    ...
    <tr>
        <td colspan="2" style="width:100%">
         <cc2:UpdatePanel ID="UpdatePN" runat="server">
          <ContentTemplate>
            <asp:DataList ID="dtList" runat="server" OnItemDataBound="data" RepeatDirection="Vertical" Width="100%">
                <ItemTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" class="table_sp">
                        <tr valign="middle">
                            ...
                            <td align="center">
                                ...
                                <img src="../Images/add_cart.gif" alt="" /></a><br />
