<%@ Page Language="C#" MasterPageFile="~/User2.Master" AutoEventWireup="true" CodeBehind="ShowNews.aspx.cs" Inherits="WebComputer.Home.ShowNews" Title="Welcome to Chien Yen Computer" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td>
            <div class="font_tintuc">Tin Tức</div>
        </td>
    </tr>
    <tr>
        <td>
